...
class Channel extends Component {
  ...
  async handleSubmitNewChannel(event) {
    ...
    var groupName = this.state.web3.utils.fromAscii(event.target.GroupName.value).padEnd(66, '0');
    var addresses = [];
    ...
    console.log(groupName,addresses,tokenAddress,expiry);
    ...
    // alert(_this.state.web3.utils.toAscii((receipt.events.GroupCreated.returnValues._name).slice(0,-66)) + " Successfully created!");
